...
public abstract class AbstractTestBooking<IReservationSession, IManagerSession> extends AbstractTesting {
	 ...
	 * one manager for all car rental companies).
	 * 
	...
	protected void processLine(String name, String cmd, List<Character> flags, StringTokenizer scriptLineTokens)
		...
		if (cmd.equals("BA")) {
			...
			/*
			 * try{ ManagerSession aMgmtSession = getNewManagerSession("CarRent", name);
			 * System.out.println("Number of reservations by " + name + ":\t" +
			 * getNumberOfReservationsBy(aMgmtSession, name)); System.out.println(); } catch
			 * (Exception e) { throw new ApplicationException(e); }
			 */
