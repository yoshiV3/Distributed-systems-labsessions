...
public abstract class AbstractTestBooking<IReservationSession, IManagerSession> extends AbstractTesting {
     ...
     * @throws Exception if things go wrong, throw exception
     */
    protected abstract void checkForAvailableCarTypes(IReservationSession session, Date start, Date end) throws Exception;
     ...
     * @throws Exception if things go wrong, throw exception
     */
    protected abstract void addQuoteToSession(IReservationSession session, String name,
     ...
     * @throws Exception if things go wrong, throw exception
     */
    protected abstract int getNumberOfReservationsForCarType(IManagerSession ms, String carRentalName, String carType) throws Exception;    
	...
	protected void processLine(String name, String cmd, List<Character> flags, StringTokenizer scriptLineTokens) throws ApplicationException {
		...
		//
		System.out.println("\n=============== Processing the script ===name: "+name+" cmd "+cmd+" ===========\n");
